...
- **Desktop opens a mini-app in a native window** (`open_mini_app`) where web promotes it to `GameModal`. Same `app_open` event, different presentation, and not a parity gap — do not "fix" it by adding the modal to desktop.
