...
import type { Message, Attachment, User, HubEmoji } from "../../types";
        ...
        <div className="composer-shell">
          <div style={{ position: "relative", flex: 1 }}>
            ...
            <input
              ...
              onCompositionStart={() => { if (isComposing) isComposing.current = true; }}
              onCompositionEnd={(e) => {
                if (isComposing) isComposing.current = false;
