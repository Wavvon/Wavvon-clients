...
// MediaStream (canvas.captureStream). Ported from the desktop BackgroundProcessor
// and extended with a looping-video background; the model + WASM are served
// locally from /mediapipe/* (see the mediapipeAssets Vite plugin), so no CDN.
